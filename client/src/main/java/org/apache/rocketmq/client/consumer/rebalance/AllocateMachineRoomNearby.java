    ...
    public List<MessageQueue> allocate(String consumerGroup, String currentCID, List<MessageQueue> mqAll,
        ...
        for (MessageQueue mq : mqAll) {
            ...
            if (StringUtils.isNoneEmpty(brokerMachineRoom)) {
                ...
                throw new IllegalArgumentException("Machine room is null for service " + mq);
            }
        }
        ...
        //1.allocate the service that deploy in the same machine room with the current consumer
        ...
        //2.allocate the rest service to each machine room if there are no consumer alive in that machine room
